...
public class LoginCommand(UserManager<User> _userManager, SignInManager<User> _signInManager, ClaimsService _claimsService, JwtService _jwtService) : IRequestHandler<LoginRequest, ApiResponse<BaseAuthResponse>>
{
